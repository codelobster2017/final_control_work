...
INSERT INTO cat (animal_name,commands, date_of_birth) VALUES 
	('Тёма', 'meow', '2021-01-01'),
	('Гермес', 'meow, stand', '2019-12-10'),
    ('Леопольд', 'meow, wlow', '2020-02-02'),
    ('Базилио', 'meow', '2022-03-03'),
    ('Лапка', 'meow', '2018-05-05');
   
INSERT INTO dog (animal_name,commands, date_of_birth) VALUES 
	('Трезор', 'voice', '2021-01-01'),
	('Жучка', 'sit', '2019-12-10'),
    ('Мильтон', 'left paw', '2020-02-02'),
    ('Нагайна', 'right paw', '2022-03-03'),
    ('Тревор', 'voice', '2018-05-05');
    
INSERT INTO hamster (animal_name,commands, date_of_birth) VALUES 
	('Кыш', 'eat', '2021-01-01'),
	('Соня', 'eat', '2019-12-10'),
    ('Джерри', 'left paw', '2020-02-02'),
    ('Живоглот', 'right paw', '2022-03-03'),
    ('Тотошка', 'meow', '2018-05-05');
    
INSERT INTO horse (animal_name,commands, date_of_birth) VALUES 
	('Каштанка', 'eat', '2021-01-01'),
	('Бим', 'eat', '2019-12-10'),
    ('Булька', 'left paw', '2020-02-02'),
    ('Олимп', 'right paw', '2022-03-03'),
    ('Меркурий', 'meow', '2018-05-05');
    
INSERT INTO camel (animal_name,commands, date_of_birth) VALUES 
	('Галактика', 'eat', '2021-01-01'),
	('Гвоздика', 'eat', '2019-12-10'),
    ('Фантазия', 'left paw', '2020-02-02'),
    ('Флорида', 'right paw', '2022-03-03'),
    ('Кассеопея', 'meow', '2018-05-05');
    
INSERT INTO donkey (animal_name,commands, date_of_birth) VALUES 
	('Гром', 'eat', '2021-01-01'),
	('Душка', 'eat', '2019-12-10'),
    ('Жук', 'left paw', '2020-02-02'),
    ('Зорька', 'right paw', '2022-03-03'),
    ('Искра', 'meow', '2018-05-05');
